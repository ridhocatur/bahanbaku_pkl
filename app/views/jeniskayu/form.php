      ...
      <input type="hidden" name="id" id="id">
        <div class="box-body">
            ...
            <div class="form-group row">
                <label for="level" class="col-sm-3 col-form-label text-md-right">Kode</label>
                <div class="col-md-7">
                    <input id="kd_jenis" type="text" class="form-control" name="kd_jenis" required autocomplete="kd_jenis" autofocus>
                </div>
            </div>
